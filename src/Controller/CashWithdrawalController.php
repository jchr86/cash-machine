 ...
 */
class CashWithdrawalController extends AbstractController
{
    /**
     ...
     * @return Response
     */
    public function index(Request $request, SessionInterface $session, CashMachine $cashMachine): Response
    {
        ...
        return $this->render('cash_withdrawal/index.html.twig', [
    ...
    public function success(SessionInterface $session): Response
    {
        ...
        return $this->render('cash_withdrawal/success.html.twig', [
            'bills' => $bilss,
            'amount' => $amount,
